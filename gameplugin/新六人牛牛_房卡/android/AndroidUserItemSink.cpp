		...
		case IDI_CALL_BANKER:		//叫庄定时
			{
				...
				CallBanker.bBanker = rand () % 100 > 50;
				...
				{
					CallBanker.cbBankerTimes = rand() % 5 + 1;
				}
		...
		case IDI_USER_ADD_SCORE:	//加注定时
			{
				...
				{
					lAddScore = m_lFreeConfig[rand() % MAX_CONFIG];
	...
	case GS_TK_FREE:		//空闲状态
		{
			...
			m_lMinTableScore = pStatusFree->lMinTableScore;
	...
	case GS_TK_CALL:	// 叫庄状态
		{
			...
			m_lMinTableScore = pStatusCall->lMinTableScore;
	...
	case GS_TK_SCORE:	//下注状态
		{
			...
			m_lMinTableScore = pStatusScore->lMinTableScore;
	...
	case GS_TK_PLAYING:	//游戏状态
		{
			...
			m_lMinTableScore = pStatusPlay->lMinTableScore;
