...
echo *************************************************************************
echo                              网狐棋牌精华版一键安装
echo     执行网狐棋牌精华版数据库一键安装脚本，自动备份"D:\数据库\精华平台"目录下的数据库，
echo 自动创建网狐棋牌精华版初始数据库。请按任意键继续...
echo *************************************************************************
pause
echo.
echo 正在清理数据库
...
md D:\数据库\精华平台备份\%ymd%
XCOPY D:\数据库\精华平台\* D:\数据库\精华平台备份\%ymd% /s  /e
if exist D:\数据库\精华平台 (echo y|cacls D:\数据库\精华平台 /p everyone:f >nul 2>nul &&rd /s /q D:\数据库\精华平台) 
md D:\数据库\精华平台
...
echo.
echo *************************************************************************
echo 网狐棋牌精华版一键安装已经建立网狐棋牌精华版数据库
echo 无需生成游戏标识，请直接关闭
