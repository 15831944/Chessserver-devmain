...
CDlgCustomRule::CDlgCustomRule() : CDialog(IDD_CUSTOM_RULE)
{
	...
	m_CustomRule.lRoomStorageStart = 500000;
	m_CustomRule.lRoomStorageDeduct = 0;
	m_CustomRule.lRoomStoragePer0 = 9;
	m_CustomRule.lRoomStoragePer1 = 27;
	m_CustomRule.lRoomStorageMax1 = 500000;
	m_CustomRule.lRoomStorageMul1 = 48;
	m_CustomRule.lRoomStorageMax2 = 2000000;
	m_CustomRule.lRoomStorageMul2 = 59;
...
BOOL CDlgCustomRule::OnInitDialog()
{
	...
	((CEdit *)GetDlgItem(IDC_EDIT_ROOMSTORAGE_PER0))->LimitText(2);
	((CEdit *)GetDlgItem(IDC_EDIT_ROOMSTORAGE_PER1))->LimitText(2);
...
bool CDlgCustomRule::FillDataToControl()
{
	...
	SetDlgItemInt(IDC_EDIT_ROOMSTORAGE_PER0, m_CustomRule.lRoomStoragePer0);
	SetDlgItemInt(IDC_EDIT_ROOMSTORAGE_PER1, m_CustomRule.lRoomStoragePer1);
...
bool CDlgCustomRule::FillControlToData()
{
	...
	m_CustomRule.lRoomStoragePer0 = (SCORE)GetDlgItemInt(IDC_EDIT_ROOMSTORAGE_PER0);
	m_CustomRule.lRoomStoragePer1 = (SCORE)GetDlgItemInt(IDC_EDIT_ROOMSTORAGE_PER1);
