...
CDlgPersonalRule::CDlgPersonalRule() : CDialog(IDD_PERSONAL_RULE)
{
	...
	m_OxSixXSpecialRule.cbBeBankerCon[0] = 0;
	m_OxSixXSpecialRule.cbBeBankerCon[1] = 100;
	m_OxSixXSpecialRule.cbBeBankerCon[2] = 150;
	m_OxSixXSpecialRule.cbBeBankerCon[3] = 200;

	m_OxSixXSpecialRule.cbUserbetTimes[0] = 0;
	m_OxSixXSpecialRule.cbUserbetTimes[1] = 5;
