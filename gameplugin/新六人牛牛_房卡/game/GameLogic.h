...
#define CT_ADDTIMES_OX_VALUE_SHUNZI			11									//顺子
#define CT_ADDTIMES_OX_VALUE_SAMEFLOWER		12									//同花
#define CT_ADDTIMES_OX_VALUE_HULU			13									//葫芦
#define CT_ADDTIMES_OX_VALUE_FOURFLOWER		14									//四花牛
#define CT_ADDTIMES_OX_VALUE_FIVEFLOWER		15									//五花牛
#define CT_ADDTIMES_OX_VALUE_FIVESNIUNIU	16									//五小牛
#define CT_ADDTIMES_OX_VALUE_BOMB			17									//炸弹
#define CT_ADDTIMES_OX_VALUE_TONGHUASHUN	18									//同花顺
