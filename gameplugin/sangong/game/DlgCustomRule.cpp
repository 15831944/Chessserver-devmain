...
bool CDlgCustomRule::FillDataToControl()
{
	...
	//m_CustomRule.cbBaseScore
	SetDlgItemInt(IDC_EDIT_BSCORE, m_CustomRule.dwBaseScore > 0 ? m_CustomRule.dwBaseScore:1);
...
bool CDlgCustomRule::FillControlToData()
{
	...
	m_CustomRule.dwBaseScore=GetDlgItemInt(IDC_EDIT_BSCORE);
	if (m_CustomRule.dwBaseScore == 0) m_CustomRule.dwBaseScore = 1;
