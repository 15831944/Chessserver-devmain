...
//登录模式
#define SUB_MB_LOGON_GAMEID         1 //ID登录(Obsolete)
#define SUB_MB_LOGON_ACCOUNTS       2 //帐号登录
#define SUB_MB_REGISTER_ACCOUNTS    3 //绑定帐号
#define SUB_MB_LOGON_OTHERPLATFORM  4 //其他登录(Obsolete)
#define SUB_MB_LOGON_VISITOR        5 //游客登录
#define SUB_MB_REGISTER_CODE        6 //短信验证码
#define SUB_MB_RESETPASS_CODE       7 //重置密码验证码
#define SUB_MB_RESETPASSWD          8 //重置密码
...
#define SUB_MB_LOGON_REPRET           199	//common MDM_MB_LOGON reply
