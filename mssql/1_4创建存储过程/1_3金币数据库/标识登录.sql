...
BEGIN
	...
	--查询代理
	SELECT @AgentID = UserID FROM WHJHAccountsDBLink.WHJHAccountsDB.dbo.AccountsAgent  where UserID = @SpreaderID
...
--		SET TRANSACTION ISOLATION LEVEL READ COMMITTED
	...
	-- 进入记录
	INSERT RecordUserInout (UserID, EnterScore, EnterGrade, EnterInsure,  EnterDiamond, KindID, ServerID, EnterClientIP, EnterMachine)
	VALUES (@UserID, @Score, @Grade, @Insure, @Dimand,@wKindID, @wServerID, @strClientIP, @strMachineID)
