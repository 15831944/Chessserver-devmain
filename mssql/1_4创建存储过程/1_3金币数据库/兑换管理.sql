...
BEGIN
	...
	SELECT @Nullity=Nullity, @CurrMemberOrder=MemberOrder FROM WHJHAccountsDBLink.WHJHAccountsDB.dbo.AccountsInfo WHERE UserID=@dwUserID
...
--	UPDATE UserCurrencyInfo SET Currency=Currency-@ConsumeCurrency WHERE UserID=@dwUserID
	...
	-- 删除过期
	DELETE FROM WHJHAccountsDBLink.WHJHAccountsDB.dbo.AccountsMember
...
BEGIN
	...
	SELECT @Nullity=Nullity FROM WHJHAccountsDBLink.WHJHAccountsDB.dbo.AccountsInfo WHERE UserID=@dwUserID
	...
	SELECT @ExchangeRate=StatusValue FROM WHJHAccountsDBLink.WHJHAccountsDB.dbo.SystemStatusInfo WHERE StatusName=N'MedalExchangeRate'
...
--	SELECT @CurrBeans=Currency FROM UserCurrencyInfo WHERE UserID=@dwUserID	
	...
	-- 插入记录
	INSERT WHJHRecordDBLink.WHJHRecordDB.dbo.RecordConvertUserMedal (UserID, CurInsureScore, CurUserMedal, ConvertUserMedal, ConvertRate, IsGamePlaza, ClientIP, CollectDate)
...
--	SELECT @UserBeans=Currency FROM UserCurrencyInfo WHERE UserID=@dwUserID	
	...
	-- 兑换比率
	DECLARE @ExchangeRate INT
	SELECT @ExchangeRate=StatusValue FROM WHJHAccountsDBLink.WHJHAccountsDB.dbo.SystemStatusInfo WHERE StatusName=N'RateGold'
