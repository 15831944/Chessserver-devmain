...
BEGIN
	...
	--FROM WHJHPlatformDBLink.WHJHPlatformDB.dbo.GlobalPlayPresent WHERE ServerID=@wServerID
	--IF @ServerID IS NULL
	--BEGIN
	--	SELECT @ServerID=ServerID,@PresentMember=PresentMember,@CellPlayPresnet=CellPlayPresnet,@CellPlayTime=CellPlayTime,@StartPlayTime=StartPlayTime,
	--	@CellOnlinePresent=CellOnlinePresent,@CellOnlineTime=CellOnlineTime,@StartOnlineTime=StartOnlineTime,
	--	@IsPlayPresent=IsPlayPresent,@IsOnlinePresent=IsOnlinePresent
	--	FROM WHJHPlatformDBLink.WHJHPlatformDB.dbo.GlobalPlayPresent WHERE ServerID=-2
	--	IF @ServerID IS NULL
	--	BEGIN
	--		SET @IsPlayPresent=0
	...
	--FROM WHJHPlatformDBLink.WHJHPlatformDB.dbo.GlobalPlayPresent WHERE ServerID=-3
	...
	--	SELECT @UserDatePresent=PresentScore FROM WHJHTreasureDBLink.WHJHTreasureDB.dbo.StreamPlayPresent WHERE DateID=@DateID AND UserID=@dwUserID
	...
	--	SELECT @UserPresent=SUM(PresentScore) FROM WHJHTreasureDBLink.WHJHTreasureDB.dbo.StreamPlayPresent WHERE UserID=@dwUserID
 ...
 --   SELECT @MemberOrder=MemberOrder FROM WHJHAccountsDBLink.WHJHAccountsDB.dbo.AccountsInfo WHERE UserID=@dwUserID
	...
	--BEGIN		
	--	-- 更新用户金币
	--	UPDATE WHJHTreasureDBLink.WHJHTreasureDB.dbo.GameScoreInfo set Score=Score+@PresentScore WHERE UserID=@dwUserID

	--	UPDATE WHJHTreasureDBLink.WHJHTreasureDB.dbo.StreamPlayPresent SET PresentCount=PresentCount+1,PresentScore=PresentScore+@PresentScore,
	...
	--	IF @@ROWCOUNT=0
	--	BEGIN
	--		INSERT WHJHTreasureDBLink.WHJHTreasureDB.dbo.StreamPlayPresent (DateID,UserID,PresentCount,PresentScore,PlayTimeCount,OnLineTimeCount)
