...
public:		
	...
	virtual bool __cdecl    AddVideoData(WORD wMsgKind,CMD_S_CallScore *pVideoCall);
	virtual bool __cdecl	AddVideoData(WORD wMsgKind,CMD_S_BankerInfo *pVideoBanker);
	virtual bool __cdecl    AddVideoData(WORD wMsgKind,CMD_S_StatusPlay *pVideoPlay);
	virtual bool __cdecl    AddVideoData(WORD wMsgKind,CMD_S_OutCard *pVideoOutCard);
	virtual bool __cdecl    AddVideoData(WORD wMsgKind,CMD_S_PassCard *pVideoPassCard);
