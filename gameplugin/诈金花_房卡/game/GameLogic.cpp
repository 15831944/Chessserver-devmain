...
void CGameLogic::RandCardList(BYTE cbCardBuffer[], BYTE cbBufferCount)
{
	...
	int count = CountArray(m_cbCardListData);
	...
	do {
		bPosition = crand.Number(count)%(count-bRandCount);
		cbCardBuffer[bRandCount++] = cbCardData[bPosition];
		cbCardData[bPosition] = cbCardData[count-bRandCount];
