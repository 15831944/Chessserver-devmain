...
public:		
	...
	virtual bool __cdecl	AddVideoData(WORD wMsgKind,CMD_S_GiveUp *pVideoGiveUp);
	virtual bool __cdecl    AddVideoData(WORD wMsgKind,CMD_S_CompareCard *pVideoCompareCard);
	virtual bool __cdecl    AddVideoData(WORD wMsgKind,CMD_S_LookCard *pVideoLookCard);
