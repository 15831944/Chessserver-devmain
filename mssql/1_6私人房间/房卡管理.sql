...
BEGIN
	...
	--SELECT @ExchangeRate=StatusValue FROM WHJHAccountsDBLink.WHJHAccountsDB.dbo.SystemStatusInfo WHERE StatusName=N'GeneralRoomCardExchRate'
	SELECT @ExchangeRate=UseResultsGold FROM WHJHPlatformDBLink.WHJHPlatformDB.dbo.GameProperty WHERE ID=501
	...
	INSERT INTO WHJHRecordDB..RecordRoomCard(SourceUserID, SBeforeCard, RoomCard, TargetUserID, TBeforeCard,   Gold, Remarks, ClientIP, CollectDate)
