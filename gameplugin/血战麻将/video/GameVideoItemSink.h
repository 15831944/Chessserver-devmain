...
public:		
	...
	//增加录像数据
	virtual bool __cdecl    AddVideoData(WORD wMsgKind,Video_GameStart *pVideoGameStart,bool first);
	virtual bool __cdecl    AddVideoData(WORD wMsgKind, CMD_S_CallCard *pVideoCallCard);
	virtual bool __cdecl    AddVideoData(WORD wMsgKind, CMD_S_BankerInfo *pVideoBankerInfo, bool first);
	...
	virtual bool __cdecl    AddVideoData(WORD wMsgKind, Video_OperateResult *pVideoOperateResult);
	virtual bool __cdecl    AddVideoData(WORD wMsgKind, Video_GameEnd *pVideoGameEnd);
	virtual bool __cdecl    AddVideoData(WORD wMsgKind, Video_ChiHu *pVideoChiHu);
	virtual bool __cdecl    AddVideoData(WORD wMsgKind, Video_ChangeCardResult *pVideoChangeCardResult);
