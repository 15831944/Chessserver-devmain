...
BEGIN
	...
	SELECT @AuthRealAward=StatusValue FROM WHJHAccountsDBLink.WHJHAccountsDB.dbo.SystemStatusInfo WHERE StatusName=N'AuthentPresent'
	
	DECLARE @AuthentDisable AS BIGINT
	SELECT @AuthentDisable=StatusValue FROM WHJHAccountsDBLink.WHJHAccountsDB.dbo.SystemStatusInfo WHERE StatusName=N'AuthentDisable'	
	-- 抛出数据
