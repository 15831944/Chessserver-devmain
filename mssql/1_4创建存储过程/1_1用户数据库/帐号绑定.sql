...
BEGIN
	...
	-- 积分归零
	INSERT WHJHTreasureDBLink.WHJHTreasureDB.dbo.GameScoreInfo (UserID, Score, RegisterIP, LastLogonIP,RegisterMachine) VALUES (@BindUserID, 0, @strClientIP, @strClientIP,@strMachineID) 
	...
	-- 查询金币
	SELECT @Score=Score, @Insure=InsureScore FROM WHJHTreasureDBLink.WHJHTreasureDB.dbo.GameScoreInfo WHERE UserID=@dwUserID
	...
	-- 合并绑定	
	UPDATE WHJHTreasureDBLink.WHJHTreasureDB.dbo.GameScoreInfo SET Score =  Score + @Score, InsureScore=InsureScore+@Insure WHERE UserID = @BindUserID
