...
struct CMD_S_RECORD
{
	...
	LONGLONG lDetailScore[GAME_PLAYER][32];	//单局结算分
};
...
struct CMD_S_StatusFree
{
	...
	//私人房信息
	LONGLONG						lPersonalInitScore;
	BYTE									cbPersonalGameCount;
	BYTE									cbPersonalPlayerMode;
};
...
struct CMD_S_GameEnd
{
	...
	LONGLONG						lMinTableScore;						//最低积分（机器人使用）
};
