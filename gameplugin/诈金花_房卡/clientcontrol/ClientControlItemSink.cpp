    ...
    : IClientControlDlg(CClientControlItemSinkDlg::IDD, pParent)
{
    ...
    m_wRoomStoragePer0 = 0;
    m_wRoomStoragePer1 = 0;
...
void CClientControlItemSinkDlg::DoDataExchange(CDataExchange *pDX)
{
    ...
    DDX_Control(pDX, IDC_EDIT_ROOMSTORAGE_PER0, m_editStoragePer0);
    DDX_Control(pDX, IDC_EDIT_ROOMSTORAGE_PER1, m_editStoragePer1);
...
BOOL CClientControlItemSinkDlg::OnInitDialog()
{
    ...
    m_editStoragePer0.LimitText(2);
    m_editStoragePer1.LimitText(2);
    ...
    SendControlMessage(SUB_C_REQUEST_UDPATE_ROOMINFO, 0, 0);
...
bool CClientControlItemSinkDlg::OnControlMessage(WORD nMessageID, WORD wTableID, void *pBuffer, WORD wDataSize)
{
    ...
    case SUB_S_USER_CONTROL:
    {
        ...
        RoomUserControlResult(pUserControl);
    ...
    case SUB_S_USER_CONTROL_COMPLETE:
    {
        ...
        UserControlComplete(pUserControlComplete);
...
void CClientControlItemSinkDlg::SetStorageInfo(CMD_S_ADMIN_STORAGE_INFO *pStorageInfo)
{
    ...
    strBuf.Format(TEXT("%d"), pStorageInfo->wRoomStoragePer0);
    GetDlgItem(IDC_EDIT_ROOMSTORAGE_PER0)->SetWindowText(strBuf);
    strBuf.Format(TEXT("%d"), pStorageInfo->wRoomStoragePer1);
    GetDlgItem(IDC_EDIT_ROOMSTORAGE_PER1)->SetWindowText(strBuf);

    //保存数值
    m_lRoomStorageCurrent = pStorageInfo->lRoomStorageCurrent;
    m_lRoomStorageDeduct = pStorageInfo->lRoomStorageDeduct;
    m_wRoomStoragePer0 = pStorageInfo->wRoomStoragePer0;
    m_wRoomStoragePer1 = pStorageInfo->wRoomStoragePer1;
...
void CClientControlItemSinkDlg::OnModifyStorage()
{
    ...
    CString strPer0;
    CString strPer1;
    GetDlgItemText(IDC_EDIT_ROOMSTORAGE_PER0, strPer0);
    GetDlgItemText(IDC_EDIT_ROOMSTORAGE_PER1, strPer1);

    //校验是否为空值
    if(strlMaxStorage0 == TEXT("") || strlMaxStorage1 == TEXT("")
        || strMul0 == TEXT("") || strMul1 == TEXT("")
        || strPer0 == TEXT("") || strPer1 == TEXT(""))
    {
        ...
        strBuf.Format(TEXT("%d"), m_wRoomStoragePer0);
        GetDlgItem(IDC_EDIT_ROOMSTORAGE_PER0)->SetWindowText(strBuf);
        strBuf.Format(TEXT("%d"), m_wRoomStoragePer1);
        GetDlgItem(IDC_EDIT_ROOMSTORAGE_PER1)->SetWindowText(strBuf);
        return;
    }
    ...
    modifyStorage.wRoomStoragePer0 = GetDlgItemInt(IDC_EDIT_ROOMSTORAGE_PER0);
    modifyStorage.wRoomStoragePer1 = GetDlgItemInt(IDC_EDIT_ROOMSTORAGE_PER1);
    ...
    if(modifyStorage.wRoomStorageMul[0] < 0 || modifyStorage.wRoomStorageMul[0] > 100 ||
        ...
        modifyStorage.wRoomStoragePer0 < 0 || modifyStorage.wRoomStoragePer0 > 100 ||
        modifyStorage.wRoomStoragePer1 < 0 || modifyStorage.wRoomStoragePer1 > 100)
    {
    ...
    else
    {
        ...
        m_wRoomStoragePer0 = modifyStorage.wRoomStoragePer0;
        m_wRoomStoragePer1 = modifyStorage.wRoomStoragePer1;
    }
}

//更新库存
void CClientControlItemSinkDlg::OnUpdate()
{
    SendControlMessage(SUB_C_REQUEST_UDPATE_ROOMINFO, 0, 0);
}
...
void CClientControlItemSinkDlg::OnUpdateStorage()
{
    ...
    SendControlMessage(SUB_C_STORAGE, &UpdateStorage, sizeof(UpdateStorage));
...
void CClientControlItemSinkDlg::OnEnSetfocusEditUserId()
{
    ...
    SendControlMessage(SUB_C_CLEAR_CURRENT_QUERYUSER, 0, 0);
}
...
void CClientControlItemSinkDlg::OnContinueControlWin()
{
    ...
    SendControlMessage(SUB_C_USER_CONTROL, &UserControl, sizeof(UserControl));
}
...
void CClientControlItemSinkDlg::OnBnClickedBtnUserBetQuery()
{
    ...
    SendControlMessage(SUB_C_REQUEST_QUERY_USER, &QueryUser, sizeof(QueryUser));
}
