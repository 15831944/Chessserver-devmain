...
#define GAME_NAME					TEXT("欢乐30秒")						//游戏名字
...
#define SUB_S_AMDIN_COMMAND			1									//管理员命令
#define SUB_S_UPDATE_STORAGE        2									//更新库存
#define SUB_S_SEND_USER_BET_INFO    3									//发送下注
...
struct CMD_S_SendUserBetInfo
{
    ...
    LONG							lUserJettonScore[GAME_PLAYER][AREA_MAX];	//个人总注
};
